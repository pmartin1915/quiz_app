...
const EXAMS = [
    ...
    { id: 'exam4m', name: 'Exam 4 — Previously Missed', data: 'EXAM4_MISSED_DATA', categories: ['Hematology', 'Cardiovascular', 'Infectious Diseases', 'MSK', 'Rheumatology', 'OB', 'OB/GYN', 'GYN', 'GU', "Men's Health", 'GI', 'Endocrine', 'Integumentary', 'Pulmonary', 'Neurology', 'Mental Health', 'Diagnostic Testing'], questionCount: 40, timeSeconds: 60 * 60 },
    { id: 'exam4c', name: 'Exam 4 — Comp / Other', data: 'EXAM4_COMP_DATA', categories: ['Hematology', 'Infectious Diseases', 'OB', 'OB/GYN', 'GYN', 'MSK', 'Rheumatology', 'GU', "Men's Health", 'Genetics', 'Diagnostic Testing'], questionCount: 51, timeSeconds: 77 * 60 },
